'use strict';var dayjs=require('dayjs'),dayjsIsSameOrAfter=require('dayjs/plugin/isSameOrAfter'),dayjsIsSameOrBefore=require('dayjs/plugin/isSameOrBefore'),dayjsIsBetween=require('dayjs/plugin/isBetween'),React=require('react'),material=require('@mui/material'),reactDom=require('react-dom'),sortable=require('@dnd-kit/sortable'),core=require('@dnd-kit/core'),reactForm=require('@pdg/react-form');function _interopNamespaceDefault(e){var n=Object.create(null);if(e){Object.keys(e).forEach(function(k){if(k!=='default'){var d=Object.getOwnPropertyDescriptor(e,k);Object.defineProperty(n,k,d.get?d:{enumerable:true,get:function(){return e[k]}});}})}n.default=e;return Object.freeze(n)}var React__namespace=/*#__PURE__*/_interopNamespaceDefault(React);/******************************************************************************
...
var TableBodyCell = function (_a) {
    ...
    var data = React.useMemo(function () {
            ...
            case 'img':
                {
                    ...
                    data = (React.createElement("a", { href: data, target: '_blank', onClick: menuOpen
                        ...
                        React.createElement(material.Tooltip, __assign$3({ className: 'TableBodyCell-tooltip', title: React.createElement("div", { style: { paddingTop: 3, paddingBottom: 3 } }, img) }, column.tooltipProps, { placement: placement }), img)));
                }
                break;
            case 'date':
                if (data) {
        ...
        if (column.type !== 'img') {
            ...
            if (tooltip) {
                data = (React.createElement(material.Tooltip, __assign$3({ className: 'TableBodyCell-tooltip', title: tooltip }, column.tooltipProps), React.isValidElement(data) ? (data.type === React.Fragment ? (React.createElement("span", null, data)) : (data)) : (React.createElement("span", null, data))));
            }
        }
        return data;
...
TableBodyRow.defaultProps = TableBodyRowDefaultProps;var TableHeadCell = function (_a) {
    ...
    // Render ------------------------------------------------------------------------------------------------------------
    return (React.createElement(TableCommonCell, { type: 'head', className: 'TableHeadCell', column: column, defaultAlign: defaultAlign }, data));
...
var Table = React.forwardRef(function (_a, ref) {
    ...
    return finalColumns ? (React.createElement(TableContextProvider, { value: tableContextValue },
        React.createElement(material.Paper, { ref: fullHeight ? containerHeightDetector : undefined, className: classNames('Table', className, !!stickyHeader && 'sticky-header', !!fullHeight && 'full-height', !!showOddColor && 'odd-color', !!showEvenColor && 'even-color', !!sortable$1 && 'sortable'), variant: 'outlined', style: style, sx: sx },
                ...
                React.createElement(core.DndContext, { sensors: sensors, collisionDetection: core.closestCenter, onDragEnd: handleDragEnd },
                    React.createElement(material.Table, { stickyHeader: stickyHeader, sx: tableSx, style: tableStyle },
                        React.createElement(material.TableHead, null,
                            React.createElement(material.TableRow, null, finalColumns.map(function (column, idx) { return (React.createElement(TableHeadCell, { key: idx, column: column, defaultAlign: defaultAlign, onCheckChange: handleHeadCheckChange })); }))),
                        React.createElement(material.TableBody, null, sortableItems ? (sortableItems.length > 0 ? (React.createElement(sortable.SortableContext, { items: sortableItems, strategy: sortable.verticalListSortingStrategy }, sortableItems.map(function (item, idx) { return (React.createElement(TableBodyRow, { key: item.id, className: classNames(!!showOddColor && 'odd-color', !!showEvenColor && 'even-color'), hover: true, sx: onGetBodyRowSx ? onGetBodyRowSx(item, idx) : undefined, id: item.id, index: idx, defaultAlign: defaultAlign, defaultEllipsis: defaultEllipsis, sortable: sortable$1, columns: finalColumns, item: item, onClick: onClick, onCheckChange: handleBodyCheckChange })); }))) : (React.createElement(StyledBodyRow$1, null,
                        ...
                        !isNoData && footer && (React.createElement(material.TableFooter, null,
            ...
            paging && paging.total > 0 && (React.createElement(material.Stack, { ref: fullHeight ? pagingHeightResizeDetector : undefined, alignItems: pagingAlign, style: pagingStyle },
...
Table.defaultProps = TableDefaultProps;var SearchTableDefaultProps = {};var SearchTable = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(material.Grid, { container: true, direction: 'column', spacing: 1, className: classNames('SearchTable', className), style: style, sx: sx },
        ...
        React.createElement(material.Grid, { item: true, style: tableContainerStyle },
            React.createElement(Table, __assign$3({}, tableInfo.props, { stickyHeader: stickyHeader || ((_b = tableInfo.props) === null || _b === void 0 ? void 0 : _b.stickyHeader), fullHeight: fullHeight || ((_c = tableInfo.props) === null || _c === void 0 ? void 0 : _c.fullHeight), ref: function (commands) {
                    if (tableInfo.ref) {
...
SearchTable.defaultProps = SearchTableDefaultProps;var TableButtonDefaultProps = {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React.createElement(material.Icon, __assign$3({ ref: ref }, props, { className: classNames('TableIcon', className) }), children));
});
...
TableIcon.defaultProps = TableIconDefaultProps;var TableButton = React.forwardRef(function (_a, ref) {
    ...
    var sx = React.useMemo(function () { return (__assign$3({ minWidth: 0, px: !startIcon && !endIcon ? 0.7 : 1.7 }, initSx)); }, [endIcon, initSx, startIcon]);
    // Render ----------------------------------------------------------------------------------------------------------
    return (React.createElement(material.Button, __assign$3({ ref: ref, className: classNames(className, 'TableButton'), type: 'button', size: 'small', sx: sx, color: color, onClick: onClick, startIcon: startIcon ? (React.createElement(TableIcon, { fontSize: 'small', sx: { mr: -0.5 } }, startIcon)) : undefined, endIcon: endIcon ? (React.createElement(TableIcon, { fontSize: 'small', sx: { ml: -0.5 } }, endIcon)) : undefined }, props),
...
TableButton.defaultProps = TableButtonDefaultProps;var TableMenuButtonDefaultProps = {
    ...
    return (React.createElement("span", null,
        React.createElement(material.Button, __assign$3({ ref: function (r) {
                if (ref) {
                    if (typeof ref === 'function') {
                        ref(r);
                    }
        ...
        React.createElement(material.Popper, { className: 'TableMenuButton-Popper', open: open, anchorEl: anchorRef.current, role: undefined, placement: placement, transition: true, style: { zIndex: inModal ? (zIndex === undefined ? 1301 : zIndex) : zIndex } }, function (_a) {
            ...
            return (React.createElement(material.Grow, __assign$3({}, TransitionProps, { style: {
            ...
            return (React.createElement(material.Grid, __assign$3({ key: idx, item: true }, finalSizeProps, { className: item.className, style: item.style, sx: item.sx }),
                ...
                React.createElement(ValueWrap, { className: classNames(valueClassName, item.valueClassName), style: __assign$3(__assign$3(__assign$3({}, valueStyle), item.valueStyle), valueUnderlineStyle), sx: finalValueSx },
                    ...
                    item.clipboard && notEmpty(copyToClipboardText_1) && (React.createElement(ValueClipboard, null,
                        React.createElement(lib.CopyToClipboard, { text: copyToClipboardText_1, onCopy: onCopyToClipboard ? function () { return onCopyToClipboard(item, copyToClipboardText_1); } : undefined },
