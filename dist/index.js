    ...
    var data = React.useMemo(function () {
        ...
        switch (column.type) {
            case 'number':
                ...
                break;
            case 'check':
                data = (React__default["default"].createElement(material.Box, { className: 'TableBoxyCell-check-box', onClick: menuOpen ? undefined : function (e) { return e.stopPropagation(); } },
                    React__default["default"].createElement(material.Checkbox, { checked: checked, disabled: checkDisabled, onChange: function (e, newChecked) {
...
var TableBodyRow = function (_a) {
    ...
    return (React__default["default"].createElement(StyledBodyRow, __assign$1({ className: classNames('TableBodyRow', className), style: finalStyle }, props, sortableProps), columns.map(function (column, columnIdx) { return (React__default["default"].createElement(TableBodyCell, { key: columnIdx, index: index, item: item, defaultAlign: defaultAlign, defaultEllipsis: defaultEllipsis, column: column, onClick: onClick, onCheckChange: onCheckChange })); })));
};
...
var Table = React__default["default"].forwardRef(function (_a, ref) {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return finalColumns ? (React__default["default"].createElement(TableContextProvider, { value: tableContextValue },
        React__default["default"].createElement(material.Paper, { ref: fullHeight ? containerHeightDetector : undefined, className: classNames('Table', className, !!stickyHeader && 'sticky-header', !!fullHeight && 'full-height', !!showOddColor && 'odd-color', !!showEvenColor && 'even-color', !!sortable$1 && 'sortable'), variant: 'outlined', style: style, sx: sx },
            React__default["default"].createElement(SimpleBar, { ref: simpleBarRef, style: simpleBarStyle },
                React__default["default"].createElement(core.DndContext, { sensors: sensors, collisionDetection: core.closestCenter, onDragEnd: handleDragEnd },
                    React__default["default"].createElement(material.Table, { stickyHeader: stickyHeader, sx: tableSx, style: tableStyle },
                        React__default["default"].createElement(material.TableHead, null,
                            React__default["default"].createElement(material.TableRow, null, finalColumns.map(function (column, idx) { return (React__default["default"].createElement(TableHeadCell, { key: idx, column: column, defaultAlign: defaultAlign, onCheckChange: handleHeadCheckChange })); }))),
                        React__default["default"].createElement(material.TableBody, null, sortableItems ? (sortableItems.length > 0 ? (React__default["default"].createElement(sortable.SortableContext, { items: sortableItems, strategy: sortable.verticalListSortingStrategy }, sortableItems.map(function (item, idx) { return (React__default["default"].createElement(TableBodyRow, { key: item.id, className: classNames(!!showOddColor && 'odd-color', !!showEvenColor && 'even-color'), hover: true, sx: onGetBodyRowSx ? onGetBodyRowSx(item, idx) : undefined, id: item.id, index: idx, defaultAlign: defaultAlign, defaultEllipsis: defaultEllipsis, sortable: sortable$1, columns: finalColumns, item: item, onClick: onClick, onCheckChange: handleBodyCheckChange })); }))) : (React__default["default"].createElement(StyledBodyRow$1, null,
                            ...
                            case 'FormTimePicker':
                                {
                                    if (notEmpty(value)) {
                                        ...
                                        var itemValue = dayjs__default["default"](value, format);
                            ...
                            case 'FormDateRangePicker':
                                {
                                    ...
                                    if (name === "".concat(itemName).concat(startNameSuffix)) {
                                        if (notEmpty(value)) {
                                            var startValue = dayjs__default["default"](value, format);
                                        ...
                                        if (notEmpty(value)) {
                                            var endValue = dayjs__default["default"](value, format);
...
TableButton.defaultProps = TableButtonDefaultProps;var TableMenuButtonDefaultProps = {
    ...
    return (React__default["default"].createElement("span", null,
        React__default["default"].createElement(material.Button, __assign$1({ ref: function (r) {
            ...
            icon && (React__default["default"].createElement(TableIcon, { fontSize: 'small', color: color }, icon)),
            children),
        React__default["default"].createElement(material.Popper, { className: 'TableMenuButton-Popper', open: open, anchorEl: anchorRef.current, role: undefined, placement: placement, transition: true, style: { zIndex: inModal ? (zIndex === undefined ? 1301 : zIndex) : zIndex } }, function (_a) {
...
var lib = CopyToClipboard;var InfoTable = function (_a) {
    ...
    return (React__default["default"].createElement(material.Grid, { container: true, spacing: spacing, columnSpacing: columnSpacing, rowSpacing: rowSpacing, className: classNames('InfoTable', className), style: style, sx: sx }, items.map(function (item, idx) {
        if (item) {
            ...
            if (empty(data))
                data = item.onRenderEmpty ? item.onRenderEmpty(info) : React__default["default"].createElement(React__default["default"].Fragment, null, "\u00A0");
            var copyToClipboardText_1 = item.clipboardText || (typeof data === 'string' ? data : typeof data === 'number' ? data.toString() : '');
            return (React__default["default"].createElement(material.Grid, __assign$1({ key: idx, item: true }, finalSizeProps, { className: item.className, style: item.style, sx: item.sx }),
                ...
                React__default["default"].createElement(ValueWrap, { className: classNames(valueClassName, item.valueClassName), style: __assign$1(__assign$1(__assign$1({}, valueStyle), item.valueStyle), valueUnderlineStyle), sx: finalValueSx },
                    ...
                    item.clipboard && notEmpty(copyToClipboardText_1) && (React__default["default"].createElement(ValueClipboard, null,
                        React__default["default"].createElement(lib.CopyToClipboard, { text: copyToClipboardText_1, onCopy: onCopyToClipboard ? function () { return onCopyToClipboard(item, copyToClipboardText_1); } : undefined },
