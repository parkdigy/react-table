...
Table.defaultProps = TableDefaultProps;var SearchTableDefaultProps = {};var SearchTable = React__default["default"].forwardRef(function (_a, ref) {
    ...
    return (React__default["default"].createElement(material.Grid, { container: true, direction: 'column', spacing: 1 },
        React__default["default"].createElement(material.Grid, { item: true, sx: { display: searchInfo.searchGroups ? undefined : 'none' } },
            React__default["default"].createElement(reactForm.Search, __assign({}, searchInfo.props, { ref: function (commands) {
                    if (searchInfo.ref) {
        ...
        React__default["default"].createElement(material.Grid, { item: true },
            React__default["default"].createElement(Table, __assign({}, tableInfo.props, { ref: function (commands) {
                    if (tableInfo.ref) {
...
SearchTable.defaultProps = SearchTableDefaultProps;var TableButtonDefaultProps = {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default["default"].createElement(material.Icon, __assign({ ref: ref }, props, { className: classNames('TableIcon', className) }), children));
});
