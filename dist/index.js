...
var TableTopHead = function (_a) {
    ...
    if (rows) {
        ...
        return React.createElement(material.TableHead, { className: 'TableHead' }, captionRow);
    }
};
